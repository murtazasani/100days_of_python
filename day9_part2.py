# Data Validation in order to calculate grade and attendance of Students.

data_valid = False
while not data_valid:
    grade1 = int(input("Type the grade of first test: "))
...
data_valid = False
while not data_valid:
    grade2 = int(input("Type the grade of second test: "))
...
data_valid = False
while not data_valid:
    grade3 = int(input("Type the grade of third test: "))
...
data_valid = False
while not data_valid:
    grade4 = int(input("Type the grade of fourth test: "))
...
data_valid = False
while not data_valid:
    absence = int(input("Enter total Number of absences: "))
